  ...
  return (
    <section className="text-center mt-24">
      ...
      <div className="mt-4 flex gap-4 justify-center">
        <Link href={"/"} className="bg-black text-white py-2 px-3 rounded-md">
          Get started for free
        </Link>
        <Link
          href={"/"}
          className="border border-gray-300 rounded-md py-2 px-4 inline-flex gap-1 items-center text-gray-800"
        >
          <Play size={16} />
          Watch video
        </Link>
